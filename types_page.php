...
<header style="text-align:center;"><b>TYPES</b></header>
...
<select style="width:50px;height:25px;margin-left:700px;color:white;background-color:black" >
<option > &#9776 </option>
		  <option > login</option>
...
<button style="margin-left:80px;background-color:green;color:white"
onclick="window.location.href = 'login_page.php'">RENT</button>
<button style="margin-left:150px;background-color:green;color:white"
onclick="window.location.href = 'login_page.php'">RENT</button>
<button style="margin-left:150px;background-color:green;color:white"
onclick="window.location.href = 'login_page.php'">RENT</button>
<button style="margin-left:150px;background-color:green;color:white"
...
<button style="margin-left:150px;background-color:green;color:white"
onclick="window.location.href = 'login_page.php'">RENT</button>
<header style="border-style:ridge"></header>
...
onclick="window.location.href = 'login_page.php'">RENT</button>
<button style="margin-left:150px;background-color:green;color:white"
onclick="window.location.href = 'login_page.php'">RENT</button></br >
<footer style="border-style:ridge"></footer>
